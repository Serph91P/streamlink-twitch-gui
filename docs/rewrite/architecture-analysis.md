...
- The current release job runs only for tags in `streamlink/streamlink-twitch-gui`; fork tags do not publish through that job. See [`.github/workflows/main.yml`](../../.github/workflows/main.yml).
